...
const className = 'FriendData';

export default class FriendData extends DDLClass {
	...
	private m_strStatus = new RVString();
	...
	public extractFrom(stream: NEXByteStream): void {
		...
		this.m_strStatus.extractFrom(stream);
	}
	...
	public toJSON(): any {
		...
		json.__fields.m_strStatus = this.m_strStatus;
