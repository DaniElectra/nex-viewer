...
const className = 'SimpleSearchDateTimeAttribute';

export default class SimpleSearchDateTimeAttribute extends DDLClass {
	...
	public extractFrom(stream: NEXByteStream): void {
		...
		this.endTime.extractFrom(stream);
	}
	...
	public toJSON(): any {
		...
		json.__fields.endTime = this.endTime;
