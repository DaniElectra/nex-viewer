...
export default class RankingOrderParam extends DDLClass {
	public get typeName(): string {
		return className;
	}

	private scoreIndexToOrderBy = new UInt8();
	private scoreOrder = new UInt8();
	private rankCalculation = new UInt8();
	...
	public extractFrom(stream: NEXByteStream): void {
		...
		this.scoreIndexToOrderBy.extractFrom(stream);
		this.scoreOrder.extractFrom(stream);
		this.rankCalculation.extractFrom(stream);
	...
	public toJSON(): any {
		...
		json.__fields.scoreIndexToOrderBy = this.scoreIndexToOrderBy;
		json.__fields.scoreOrder = this.scoreOrder;
		json.__fields.rankCalculation = this.rankCalculation;
