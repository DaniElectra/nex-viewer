...
import SearchCoursesBestTimeParam from '@/nex/protocols/datastore/super-mario-maker-2/types/search-courses-best-time-param';
...
export class Request {
	public static Name = 'SearchCoursesBestTime';

	private param = new SearchCoursesBestTimeParam();
