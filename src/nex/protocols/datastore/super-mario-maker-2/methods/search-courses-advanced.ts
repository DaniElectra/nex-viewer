...
import SearchCoursesAdvancedParam from '@/nex/protocols/datastore/super-mario-maker-2/types/search-courses-advanced-param';
...
export class Request {
	public static Name = 'SearchCoursesAdvanced';

	private param = new SearchCoursesAdvancedParam();
