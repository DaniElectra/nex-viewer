...
import SearchUsersBattleModeParam from '@/nex/protocols/datastore/super-mario-maker-2/types/search-users-battle-mode-param';
...
export class Request {
	public static Name = 'SearchUsersBattleMode';

	private param = new SearchUsersBattleModeParam();
