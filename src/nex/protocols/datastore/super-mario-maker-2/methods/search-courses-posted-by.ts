...
import SearchCoursesPostedByParam from '@/nex/protocols/datastore/super-mario-maker-2/types/search-courses-posted-by-param';
...
export class Request {
	public static Name = 'SearchCoursesPostedBy';

	private param = new SearchCoursesPostedByParam();
