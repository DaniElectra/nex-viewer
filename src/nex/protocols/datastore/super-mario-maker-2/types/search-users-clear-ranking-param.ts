...
const className = 'SearchUsersClearRankingParam';

export default class SearchUsersClearRankingParam extends DDLClass {
	...
	private unknown3 = new RVBuffer();
	private unknown4 = new ResultRange();
