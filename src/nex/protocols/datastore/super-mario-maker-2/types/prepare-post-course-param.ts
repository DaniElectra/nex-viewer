...
const className = 'PreparePostCourseParam';

export default class PreparePostCourseParam extends DDLClass {
	...
	private unknown8 = new UInt32();
	private unknown9 = new UInt32();
	private unknown10 = new UInt32();
	private unknown11 = new QBuffer();
	private unknown12 = new UInt8();
	private unknown13 = new UInt32();
	private unknown14 = new UInt16();
	private unknown15 = new UInt16();
	private unknown16 = new Bool();
	private unknown17 = new UInt32();
	private unknown18 = new UInt32();
	private unknown19 = new List(new RVString());
	...
	public extractFrom(stream: NEXByteStream): void {
		...
		this.unknown18.extractFrom(stream);
		this.unknown19.extractFrom(stream);
	}
	...
	public toJSON(): any {
		...
		json.__fields.unknown18 = this.unknown18;
		json.__fields.unknown19 = this.unknown19;
