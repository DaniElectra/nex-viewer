...
const className = 'SearchUsersBattleModeParam';

export default class SearchUsersBattleModeParam extends DDLClass {
	public get typeName(): string {
		return className;
	}

	private unknown1 = new UInt32();
	private unknown2 = new RVBuffer();
	private unknown3 = new ResultRange();
