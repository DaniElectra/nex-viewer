...
import DataStoreGetMetaByOwnerIdParam from '@/nex/protocols/datastore/animal-crossing-happy-home-designer/types/datastore-get-meta-by-owner-id-param';
...
export class Request {
	public static Name = 'GetMetaByOwnerId';

	private param = new DataStoreGetMetaByOwnerIdParam();
