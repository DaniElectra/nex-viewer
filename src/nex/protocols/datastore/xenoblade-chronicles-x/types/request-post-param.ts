...
const className = 'RequestPostParam';

export default class RequestPostParam extends DDLClass {
	...
	private unknown9 = new QBuffer();
	private unknown10 = new QBuffer();
	private unknown11 = new List(new RVString());
	private unknown12 = new RVString();
