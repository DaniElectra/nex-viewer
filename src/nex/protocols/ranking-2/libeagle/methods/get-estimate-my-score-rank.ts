...
import Ranking2EstimateMyScoreRankInput from '@/nex/protocols/ranking-2/libeagle/types/ranking2-estimate-my-score-rank-input';
...
export class Request {
	public static Name = 'GetEstimateMyScoreRank';

	private input = new Ranking2EstimateMyScoreRankInput();
